...
@section('content')
            ...
            <div class="well">
                <a href="/rendu/public/articles" class="btn btn-default" >Retour aux articles</a>
                <h1>{{$article->title}}</h1>
            ...
            <a href="/myapp/public/articles/{{$article->id}}/edit" class="btn btn-primary">Éditer l'article</a>
